...
El cierre se ejecutará según [`PlanCierreEtapa3.md`](./PlanCierreEtapa3.md), priorizando reglas de
check-in, experiencia mobile, pruebas iOS/Android y aprobación formal.
