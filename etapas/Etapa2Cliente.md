...
- Las rutas criticas de autenticacion y perfil deben estar estables.
- El backend debe quedar listo para soportar la Etapa 3 sin re-trabajo estructural.

## Nota

La Etapa 2 ya entrega la base tecnica principal del producto; lo que falta es endurecer y cerrar detalles de autenticacion antes de pasar a la siguiente etapa.
