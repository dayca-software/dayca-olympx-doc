...
| Release         |             50% | Builds, typechecks, 223 tests API y 20 tests mobile; builds nativas Android/iOS verificadas | Integración, seguridad, rendimiento, RevenueCat real y push físico |
